                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div id="sectionHomepage2-LeftSide">
                                <div>
                                    <h1>halo semuanya</h1>
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe, ut culpa nobis magnam molestias odit.</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="sectionHomepage2-RightSide-Row">
                                    <div className="row">
                                        <div className="col-md-6">
                                            <i class="far fa-clock"></i> <h3>lorem</h3>
                                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex, aliquam.</p>
                                        </div>
                                        <div className="col-md-6">
                                            <i class="fas fa-chalkboard-teacher"></i> <h3>lorem</h3>
                                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex, aliquam.</p>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-md-6">
                                            <i class="fas fa-chart-line"></i> <h3>lorem</h3>
                                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex, aliquam.</p>
                                        </div>
                                        <div className="col-md-6">
                                            <i class="fab fa-connectdevelop"></i> <h3>lorem</h3>
                                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex, aliquam.</p>
                                        </div>
                                    </div>
                                </div>
